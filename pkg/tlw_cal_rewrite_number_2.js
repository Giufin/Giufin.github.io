import { start_drawing, debug } from './snippets/tlw_cal_rewrite_number_2-ac27fe8a758df760/md.js';
import * as __wbg_star0 from './snippets/tlw_cal_rewrite_number_2-ac27fe8a758df760/md.js';
...
* @param {number} slot
*/
export function sim_char(data, effects, debufs, power, slot) {
    var ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ptr1 = passStringToWasm0(effects, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('tlw_cal_rewrite_number_2_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
